    ...
    <section>
      <header className="bg-white shadow">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Link href="/login">
            <button className="bg-[#AADC8D] text-black px-4 py-2 rounded-md font-bold rounded-lg hover:bg-green-500 transition duration-300">Go to App</button>
          </Link>
        </div>
      </header>
      ...
      <main className="text-center mt-20">
        ...
        <Link href="/login" className="bg-[#AADC8D] text-black px-4 py-2 rounded-md font-bold rounded-lg hover:bg-green-500 transition duration-300">
          Get Started
        </Link>
      </main>
    </section>
